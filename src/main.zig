...
fn Runtime(comptime EventType: type) type {
    return struct {
        const Self = @This();
        allocator: Allocator,
        ...
        fn new(allocator: Allocator, h: *const fn (allocator: Allocator, event: EventType) anyerror![]const u8) Self {
...
const APIGatewayProxyRequest = struct {
    resource: []const u8,
    path: []const u8,
    httpMethod: []const u8,
    body: []const u8,
    ...
    const Self = @This();
    fn fromJson(allocator: Allocator, body: []const u8) !Self {
